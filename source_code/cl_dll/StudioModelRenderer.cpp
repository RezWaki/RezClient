...
void APIENTRY Hooked_glBegin( GLenum mode ) {
	...
	if(CVAR_GET_FLOAT("cl_specwh") && ent_->curstate.spectator ){
...
int CStudioModelRenderer::StudioDrawPlayer( int flags, entity_state_t *pplayer )
{
	...
	/*if( CVAR_GET_FLOAT("cl_minmodels") ){
		IEngineStudio.SetRenderModel( gEngfuncs.CL_LoadModel( CVAR_GET_STRING("cl_minmodelfile"), &modelindex ) );
	}
	else{
		IEngineStudio.SetRenderModel( m_pRenderModel );
	}*/
